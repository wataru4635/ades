  ...
  <header class="header js-header">
    <div class="header__inner">
      <a href="<?php echo esc_url(home_url('')); ?>" class="header__logo-wrap">
        ...
        <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/logo.svg" class="header__logo-img"
      ...
      <nav class="header__nav">
        <ul class="header__list">
          ...
          <li class="header__item">
            <a href="<?php echo esc_url(home_url('/contact')); ?>" class="header__item-link header__item-link--contact <?php echo is_page('contact') ? 'current' : ''; ?>">
              <span class="header__contact-img-wrap">
                <img src="<?php echo get_theme_file_uri(); ?>/assets/images/common/mail-icon.svg" alt="メールのアイコン"
                  width="44" height="33">
              </span>
  ...
  <div class="header__drawer js-drawer">
    <nav class="header__drawer-nav">
      <ul class="header__drawer-items">
        ...
        <li class="header__drawer-item">
          <a href="<?php echo is_front_page() ? '#about' : esc_url(home_url('/#about')); ?>"
            class="header__drawer-item-link">about</a>
        </li>
        <li class="header__drawer-item">
          <a href="<?php echo esc_url(home_url('/works')); ?>" class="header__drawer-item-link">work</a>
        </li>
        <li class="header__drawer-item">
          <a href="<?php echo esc_url(home_url('/company')); ?>" class="header__drawer-item-link">company</a>
        </li>
      </ul>
